...
dependencies {
    ...
    implementation("${edcGroup}:jwt-core:${edcVersion}")                 // Todas las extensiones básicas ==> Control de comunicaciones HTTP
    implementation("${edcGroup}:jwt-s:${edcVersion}")                 // Todas las extensiones básicas ==> Control de comunicaciones HTTP
