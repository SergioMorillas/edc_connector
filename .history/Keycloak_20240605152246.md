...
Para hacer pruebas utilizaré docker para desplegar un servidor Keycloack http en modo development. ``docker run -p 8080:8080 -e KEYCLOAK_ADMIN=admin -e KEYCLOAK_ADMIN_PASSWORD=admin quay.io/keycloak/keycloak:24.0.5 start-dev``